...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &cachev1alpha1.Security{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &cachev1alpha1.Security{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileSecurity) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &cachev1alpha1.Security{}
	...
	// Set Security instance as the owner and controller
...
func newPodForCR(cr *cachev1alpha1.Security) *corev1.Pod {
